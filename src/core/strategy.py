...
class GBNNGreedyStrategy:
    ...
    def choose_next(self, step: int, usv: USV, cell_map: CellMap, gbnn_field: GBNNField) -> StepDecision:
        ...
        if not candidates:
            return StepDecision(None, [], {"reason": "no_traversable_neighbor"}, failure_reason="no_traversable_neighbor")
        ...
        details = {
            ...
            "direction_score": float(heading_weight * (1.0 - usv.heading_change_to(next_cell) / 4.0)),
